...
proto.Student.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    age: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
...
/**
 * optional float age = 3;
 * @return {number}
 */
proto.Student.prototype.getAge = function() {
 ...
 * @return {!proto.Student} returns this
 */
proto.Student.prototype.setAge = function(value) {
 ...
 * @return {number}
 */
proto.Student.prototype.getScore = function() {
 ...
 * @return {!proto.Student} returns this
 */
proto.Student.prototype.setScore = function(value) {
